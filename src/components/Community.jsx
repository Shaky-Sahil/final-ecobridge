...
const Card = ({ title, imageUrl, description }) => (
  <div className="card">
    ...
    <div className="card-content">
      ...
      <button  className='button-primary'><Link to={"/chat"} className='nog' style={{textDecoration: 'none'}} >Chat</Link></button>
    </div>
  </div>
);
...
const Community = () => (
  ...
  <div className="CardPage">
    <Navbar/>
    <h1 className='h1 mt-2 font-bold'>COMMUNITIES</h1><br></br>
    <h2 className='h2 mb-2'>Find your place.</h2>
