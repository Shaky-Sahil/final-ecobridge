...
function Guide1() {
  return (
   ...
   <Navbar/>
      <header className="text-center w-full">
        <h1 className="  font-bold tracking-widest text-center w-full mb-5 text-primary">How to Begin: A Guide to Effective Waste Segregation</h1>
        <p className='mb-5'>How to begin</p>
      </header>
      <div className="content">
        <div className="post">
          <h2 className='mb-2 text-primary'>How to Begin: A Guide to Effective Waste Segregation:</h2>
          <div className="post">
         <p className='mb-4'>
        ...
        <h3 className='mb-4'>Understanding the Importance:</h3>
        <p className='mb-4'>
        ...
        <h3 className='mb-4'>Gathering Segregation Tools:</h3>
        <p className='mb-4'>
        ...
        <h3 className='mb-4'>Educating Household Members:</h3>
        <p>
        ...
        <h3 className='mb-4'>Plastic Waste Segregation:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Identifying Plastic Types:</h3>
  <p>
  ...
  <h3 className='mb-4'>Clean and Dry:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Avoid Contamination:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Organic Waste Segregation:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Collect Food Scraps:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Yard Waste:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Composting:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>E-Waste Segregation:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Identify E-Waste:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Safe Disposal:</h3>
  <p className='mb-4'>
  ...
  <h3 className='mb-4'>Recycling Programs:</h3>
  <p className='mb-4'>
    Many manufacturers and electronics retailers offer e-waste recycling programs. These programs ensure that electronic devices are properly recycled, reducing the environmental impact of hazardous materials.
      ...
      <footer className="footer text-white mb-4">
